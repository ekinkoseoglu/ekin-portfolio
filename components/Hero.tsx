...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id='home'
      className='relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-50 dark:bg-slate-950 pt-16 lg:pt-0'
    >
      {/* Background blobs */}
            ...
            <ScrollReveal delay={800}>
              <div className='flex items-center gap-6 text-slate-400 dark:text-slate-500'>
                <a
                  ...
                  target='_blank'
                  rel='noreferrer'
                  className='hover:text-slate-900 dark:hover:text-white transition-colors transform hover:scale-110'
                >
                  <Github size={28} />
                </a>
                <a
          ...
          <div className='order-1 lg:order-2 flex justify-center lg:justify-end'>
            <ScrollReveal delay={400} className='w-full max-w-md lg:max-w-full'>
              <div className='relative w-72 h-72 sm:w-96 sm:h-96 lg:w-[500px] lg:h-[500px] aspect-square'>
                ...
                {/* Floating badges */}
                <div
                  className='absolute top-20 -right-8 bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl p-4 rounded-2xl shadow-xl z-20 animate-bounce'
                  style={{ animationDuration: '4s' }}
                >
                  <span className='text-3xl'>🚀</span>
                </div>
                <div
                  className='absolute bottom-20 -left-8 bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl p-4 rounded-2xl shadow-xl z-20 animate-bounce'
