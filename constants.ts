import { Experience, Project, SkillCategory, Education, Testimonial } from './types';
...
export const PERSONAL_INFO = {
  ...
  linkedin: "https://linkedin.com/in/ekinkoseoglu", // Assumed based on context
...
export const PROJECTS: Project[] = [
  {
    ...
    description: "Analyzes ticket message texts written by customers to determine mood (Emoji & Star Rate) helping support teams prioritize urgent tickets. Uses Tensorflow AI.",
    techStack: ["React", "Redux", "Tensorflow.js", "Material UI", "Formik", "Yup", "Axios"],
  ...
  },
  {
    ...
    description: "Backend for E-Commerce Prototype. Implements Layered Architecture, Generic Repository Pattern, Unit of Work, JWT, and Caching.",
    techStack: [".NET Core 5.0", "SQL Server", "Entity Framework", "Redis", "Autofac", "FluentValidation"],
...
📂Controllers
  ...
  },
  {
    ...
    description: "Frontend for CarRental Project structured with Angular 13. Features modules, routing, guards, and observables.",
  ...
  },
  {
    ...
    description: "Strictly implements OOP, SOLID and AOP principles. Provides car rental service API with extensive unit testing.",
...
📂Controllers
  ...
  },
  {
    ...
    period: "May 2021 - Present",
    description: "This is the Frontend side of my E-Commerce Project that structured with React.",
  ...
  },
  {
    ...
    description: "Created for testing Controller actions on Models representing Wordpress tables for API creation in Laravel.",
...
export const SKILL_CATEGORIES: SkillCategory[] = [
  {
    title: "Frontend",
    skills: ["React.js", "Angular", "TypeScript", "JavaScript (ES6+)", "Redux", "HTML5/CSS3", "Tailwind", "Material UI", "Semantic UI"]
  },
  {
    title: "Backend",
    skills: [".NET Core", "C#", "NodeJS", "NestJS", "Laravel (PHP)", "ASP.NET Web API", "Entity Framework"]
  },
  {
  ...
  },
  {
    ...
    skills: ["OOP", "SOLID", "AOP", "SaaS", "AI/ML Integration", "Unit Testing", "Microservices"]
  }
];
