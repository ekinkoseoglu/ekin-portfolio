...
const ContactSection: React.FC = () => {
  return (
    <section
      id='contact'
      className='min-h-screen bg-white dark:bg-slate-900 py-24 flex items-center transition-colors duration-300 relative'
    >
            ...
            <div className='bg-gradient-to-br from-brand-600 to-indigo-700 text-white p-10 md:p-12 md:w-2/5 flex flex-col justify-between relative overflow-hidden'>
              ...
              <div>
                ...
                <p className='text-brand-100 mb-10 leading-relaxed'>
                  Fill out the details or reach out via email/phone and I will
            ...
            <div className='p-10 md:p-12 md:w-3/5 flex flex-col justify-center items-center text-center'>
              <div className='max-w-sm'>
                ...
                <p className='text-slate-600 dark:text-slate-300 mb-8'>
                  "Köseoğlu is dedicated to delivering top-notch products that
                  meet user needs, driving organizational success and growth."
                </p>
                <a
                  href={`mailto:${PERSONAL_INFO.email}`}
